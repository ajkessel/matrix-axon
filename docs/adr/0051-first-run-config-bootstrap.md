...
| Account provisioning | **Skip** — accounts are added at runtime via `POST /v1/accounts/login` / `POST /v1/accounts/import`; config-based provisioning has since been retired entirely (ADR 0024) |
